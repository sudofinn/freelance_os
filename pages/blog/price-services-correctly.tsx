...
const PriceServicesCorrectly = () => {
  return (
    <div className='bg-black text-white pt-16'>
      <Head>
        <title>Price your services correctly</title>
        <meta name="description" content="Price your services correctly ( blog )" />
      </Head>
...
export default PriceServicesCorrectly