...
const TwentyTwentyFourYourYear = () => {
  return (
    <div className='bg-black text-white pt-16'>
      <Head>
        <title>Make 2024 your freelancing year</title>
        <meta name="description" content="Make 2024 your freelancing year ( blog )" />
      </Head>
...
export default TwentyTwentyFourYourYear