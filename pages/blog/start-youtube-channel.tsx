...
const StartYoutubeChannel = () => {
  return (
    <div className='bg-black text-white pt-16'>
      <Head>
        <title>Start a freelancing YouTube channel</title>
        <meta name="description" content="Start a freelancing youtube channel ( blog )" />
      </Head>
...
export default StartYoutubeChannel