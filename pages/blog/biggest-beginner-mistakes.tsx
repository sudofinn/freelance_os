...
const BiggestBeginnerMistakes = () => {
  return (
    <div className='bg-black text-white pt-16'>
      <Head>
        <title>Biggest Beginner Mistakes</title>
        <meta name="description" content="Biggest Beginner Mistakes ( blog )" />
      </Head>
...
export default BiggestBeginnerMistakes