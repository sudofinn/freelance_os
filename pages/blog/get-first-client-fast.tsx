...
const GetFirstClientFast = () => {
  return (
    <div className='bg-black text-white pt-16'>
      <Head>
        <title>Get your first client fast</title>
        <meta name="description" content="Get your first client fast ( blog )" />
      </Head>
...
export default GetFirstClientFast